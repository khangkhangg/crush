...
<style>
  *{box-sizing:border-box} body{margin:0;min-height:100svh;display:flex;align-items:flex-end;justify-content:center;padding-top:64px;
  ...
  .theme-art{width:min(52vw,180px);height:auto;filter:drop-shadow(0 18px 30px rgba(255,95,162,.34));animation:theme-float 4.2s ease-in-out infinite}
  ...
  @keyframes theme-float{0%,100%{transform:translateY(0) rotate(-1deg)}50%{transform:translateY(-8px) rotate(1deg)}}
  @media (prefers-reduced-motion:reduce){.theme-art{animation:none}}
  @media (min-width:760px){body{padding:42px;align-items:center}.mn-card{border-radius:28px;width:min(94vw,520px)}.theme-art{width:208px}}
</style></head>
...
<main class="mn-card">
  <div class="mn-hero"><img class="theme-art" src="/assets/generated/invite-envelope.png" alt="" loading="lazy" decoding="async"></div>
