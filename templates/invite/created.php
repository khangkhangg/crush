...
<?php $content = function () use ($e, $t, $link, $invite, $shareLinks) {
  ...
  <h1 style="text-wrap:balance;"><?= $e($t('Your invite is ready')) ?></h1>
  <p style="opacity:.8;"><?= $who !== '' ? $e($t('Share this private link with')) . ' <strong>' . $e($who) . '</strong>:' : $e($t('Share your private invite link:')) ?></p>
  <div style="display:flex;gap:8px;align-items:stretch;">
    ...
    <span id="copiedMsg" aria-live="polite" style="align-self:center;opacity:0;color:#16a34a;font-weight:700;font-size:13px;transition:opacity .2s;"><?= $e($t('Copied!')) ?></span>
  </div>
  ...
  <p style="margin-top:18px;"><a href="/invites" style="color:#ff3d8b;font-weight:600;"><?= $e($t('Back to your invites')) ?></a></p>
  <script>
  (function(){
